...
@Component({
  selector: 'app-invoice-bar-chart',
  templateUrl: './invoice-bar-chart.component.html',
  styleUrls: ['./invoice-bar-chart.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class InvoiceBarChartComponent implements OnInit {
  get height(): number { return parseInt(d3.select('#a').style('height'), 10); }
  get width(): number { return parseInt(d3.select('#a').style('width'), 10); }
