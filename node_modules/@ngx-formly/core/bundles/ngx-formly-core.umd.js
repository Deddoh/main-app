(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('rxjs/operators'), require('@angular/core'), require('@angular/forms'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@ngx-formly/core', ['exports', '@angular/common', 'rxjs/operators', '@angular/core', '@angular/forms', 'rxjs'], factory) :
    (factory((global['ngx-formly'] = global['ngx-formly'] || {}, global['ngx-formly'].core = {}),global.ng.common,global.rxjs.operators,global.ng.core,global.ng.forms,global.rxjs));
}(this, (function (exports,common,operators,i0,forms,rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FormlyValidationMessage = /** @class */ (function () {
         ...
         */
            function () {
                var _this = this;
                this.errorMessage$ = this.field.formControl.statusChanges.pipe(operators.startWith(null), operators.map(( /**
                 * @return {?}
                 */function () { return _this.errorMessage; })));
            };
     ...
     */ FieldValidationExtension = /** @class */ (function () {
         ...
         */
            function (field, type) {
                ...
                defineHiddenProp(field, '_' + type, type === 'validators' ? forms.Validators.compose(validators) : forms.Validators.composeAsync(( /** @type {?} */(validators))));
            };
        /**
         * @private
         * @param {?} field
     ...
     */ FieldFormExtension = /** @class */ (function () {
         ...
         */
            function (field) {
                ...
                /** @type {?} */
                var updateValidity$$1 = this.setValidators(field);
                updateValidity$$1 && (( /** @type {?} */(field.formControl)))._updateTreeValidity();
            };
        /**
         * @private
         * @param {?} field
         ...
         */
            function (field) {
                    ...
                    if (null === c_1.validator || null === c_1.asyncValidator) {
                         ...
                         */function () {
                            ...
                            var fields = c_1['_fields'].length === 1
                                 ...
                                 */function (f) { return !f._hide; }));
                            /** @type {?} */
                            var v = forms.Validators.compose(fields.map(( /**
                             * @param {?} f
                             * @return {?}
                         ...
                         */function () {
                            ...
                            var fields = c_1['_fields'].length === 1
                                 ...
                                 */function (f) { return !f._hide; }));
                            /** @type {?} */
                            var v = forms.Validators.composeAsync(fields.map(( /**
                             * @param {?} f
                             * @return {?}
                 ...
                 * @param {?} f
                 * @return {?}
                 */function (f) { return _this.setValidators(f) && (updateValidity$$1 = true); }));
